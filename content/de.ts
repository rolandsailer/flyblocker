    ...
    tabs: [
      {
        ...
        subtitle: 'Lobbys, Restaurants, Bergrestaurants & Gasthäuser',
        imageSrc: 'gastronomie',
        imageAlt: 'Hotellerie und Gastronomie – Restaurant mit gehobener Küche',
        captionTitle: 'Hotellerie/Gastronomie',
        caption:
          'Lobbys, Bergrestaurants, Shop-Eingänge, Restaurants und Gasthäuser — Komfort für Gäste, ganzjährig und diskret integriert. Gäste herein, Insekten draussen.',
      },
      {
        label: 'Bäckereien/Conditoreien',
        subtitle: 'Offene Auslagen, Frischeprodukte',
        imageSrc: 'baeckerei',
        imageAlt: 'Bäckereien und Conditoreien – frische Backwaren und offene Verkaufsfläche',
        captionTitle: 'Bäckereien/Conditoreien',
        caption: 'Schutz für offene Auslagen und Frischeprodukte — entscheidend für die Lebensmittelhygiene.',
      },
      {
        label: 'Lebensmittelverarbeitende\nIndustrie',
